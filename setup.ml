...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8bf00935b1be15786ceca8e27da8b69f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["Keigo Imai"];
          homepage = Some "https://github.com/keigoi/linocaml";
          bugreports = None;
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Lens"; "Base"; "Direct"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "linocaml";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the tests";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                     cs_name = "linocaml_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Linocaml_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "linocaml";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ppx_linocaml_empty"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "linocaml";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_linocaml_ex.ml"});
               Library
                 ({
                     cs_name = "ppx_lens";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "linlist.ml"})
            ];
     ...
     oasis_digest = Some "CM@\249\003ZI\026\249W\164\225D\rhh";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
